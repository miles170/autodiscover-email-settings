...
LABEL maintainer="Monogramm Maintainers <opensource at monogramm dot io>" \
      ...
      org.label-schema.vcs-url="https://github.com/miles170/autodiscover-email-settings" \
      ...
      org.label-schema.url="https://github.com/miles170/autodiscover-email-settings" \
      org.label-schema.vendor="Monogramm" \
      org.label-schema.version=$VERSION \
      org.label-schema.schema-version="1.0" \
      org.opencontainers.image.revision=$VCS_REF \
      org.opencontainers.image.source="https://github.com/miles170/autodiscover-email-settings" \
      ...
      org.opencontainers.image.url="https://github.com/miles170/autodiscover-email-settings" \
